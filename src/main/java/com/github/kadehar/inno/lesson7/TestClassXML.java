...
public class TestClassXML {
    public static void main(String[] args) {
        ...
        System.out.println("1. [XML] Create new players and print them");
        ...
        System.out.println("2. [XML] Find player by id and print");
        ...
        System.out.println("3. [XML] Add points to each player and print players");
        ...
        System.out.println("4. [XML] Delete player with id = 2 and print other players");
